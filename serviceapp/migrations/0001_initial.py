    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idproof', models.FileField(null=True, upload_to='file/')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='serviceapp.servicecategory')),
            ],
        ),
        migrations.CreateModel(
            name='WorkerProfile',
